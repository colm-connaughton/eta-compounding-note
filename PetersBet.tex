...
\right.
\end{align}
We can think of the parameter $g$ as the average growth factor and $r$ parameter as the variability. We must have $\left| r \right| < g$. The choice $g=\frac{21}{10}$ and $r=\frac{9}{20}$ gives the growth factors of 1.5 and 0.6 corresponding to Peters' bet in Ford and Kay. We further assume that $x_0 = 1$.
